...
#------------------------------------------------------------
print("Exercício analisador de frequênia cardíaca")

bpm = [122, 136, 150, 123, 138, 157, 165, 142, 132, 148, 162, 146, 170, 187, 185, 158]
total = len(bpm)
...
#------------------------------------------------------------
print("Exercício alocador de call center")
